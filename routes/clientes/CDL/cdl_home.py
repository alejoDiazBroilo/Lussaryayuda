...
def CDLHome():
    Servicios = [
        ('Traslados de', 'discapacidad', 'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bWFuZWphbmRvfGVufDB8fDB8fA%3D%3D&w=1000&q=80', '#CC0000', '/CDL/discapacidad'),
        ('Traslados de', 'ART', 'https://siempreauto.com/wp-content/uploads/sites/9/2022/02/serjan-midili-YWoiQV4XrfM-unsplash.jpg?w=4096', '#990000', '/CDL/art'),
        ('Traslados de', 'baja complicidad', 'https://caracol.com.co/resizer/Cdd4FCGOdI5y04aii2EbuY6eRrc=/1440x1440/filters:format(jpg):quality(70)/cloudfront-us-east-1.images.arcpublishing.com/prisaradioco/CGSL5V2PTZIFXPWNWVYGYFYV6Q.jpg', '#660000', '/CDL/adl')
    ]
